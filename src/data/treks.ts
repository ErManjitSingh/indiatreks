...
export const allTreks: TrekListingItem[] = [
  {
    ...
    title: "Triund Trek",
    summary:
      "A classic weekend escape above McLeod Ganj with panoramic Dhauladhar views and a magical night under the stars.",
    ...
    departures: ["2026-08-16", "2026-08-23", "2026-08-30", "2026-09-06"],
  ...
  },
  {
    ...
    summary:
      "Follow the Parvati River through pine forests to hot springs, riverside cafés, and a classic Kasol weekend camp.",
    ...
    departures: ["2026-08-14", "2026-08-21", "2026-08-28"],
  ...
  },
  {
    ...
    summary:
      "A serene emerald lake trek near Dharamshala with forest trails, shepherd meadows, and quiet camping nights.",
    destinationName: "McLeod Ganj",
    state: "Himachal Pradesh",
    region: "Dharamshala",
    difficulty: "easy",
    ...
    departures: ["2026-08-18", "2026-08-25", "2026-09-01"],
